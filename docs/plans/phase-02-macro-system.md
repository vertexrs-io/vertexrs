...
#### 2.11.2 Group-By Aggregations <!-- #34 -->
...
#### 2.11.4 Basic Scalar Operations <!-- #35 -->
...
#### 2.11.5 Reshaping and Concatenation <!-- #36 -->
...
#### 2.11.9 Time-Series Operations <!-- #39 -->
...
### 2.12.1 Type-Driven Dispatch <!-- #44 -->
...
### 2.12.2 Process Graph User API <!-- #46 -->
...
### 2.12.3 Incremental Correctness for Task Nodes <!-- #46 (grouped with 2.12.2) -->
